...
class NoticiasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        transaction.add(R.id.activity_noticias_container, ListaNoticiasFragment())
        transaction.commit()
    }
    ...
    override fun onAttachFragment(fragment: Fragment?) {
        ...
        if (fragment is VisualizaNoticiaFragment) {
            ...
            fragment.quandoSelecionaMenuEdicao = { noticiaSeleciona ->
                abreFormularioEdicao(noticiaSeleciona)
            }
        }
    }
